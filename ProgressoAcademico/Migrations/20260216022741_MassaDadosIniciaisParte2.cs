    ...
    public partial class MassaDadosIniciaisParte2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder mb)
        {
            ...
            mb.Sql(@"
                ...
                SELECT
                    ...
                    'igor.ladeia@professor.ufabc.edu.br',
                    '$2b$10$XEIJUH/Emiu/WK2OFs2YmeKWOHfjkb5ebJ90piyrvgRRIpbjbYmua',
                    1,
                    NOW()
                WHERE NOT EXISTS (
                    SELECT 1 FROM Usuarios
                    WHERE Email = 'igor.ladeia@professor.ufabc.edu.br'
                );
        ...
        protected override void Down(MigrationBuilder mb)
        {
            mb.Sql(@"
                ...
                WHERE UsuarioId IN (
                    SELECT UsuarioId FROM Usuarios WHERE Email = 'igor.ladeia@professor.ufabc.edu.br'
                );
